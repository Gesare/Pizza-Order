...
$(document).ready(function () {
    ...
    $("#pick").click(function () {
        ...
        var price = (sizedPrice + crustPrice + addToppings) * pizzaNumber;
        $("#pizza-amount").text(price);
        
        var display = $("input[name='size']:checked").val() + ", " + $("input[name='crust']:checked").val() + ", " + $("#toppings option:selected").val();
        $("#details").text(display);
        // $("#details").val() = choosenSize + ", " + choosenCrust;
        // $("#details").show();
